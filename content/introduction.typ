...
In general, there are two types of magnet arrangement: homogeneous and heterogeneous arrangement. In the heterogeneous arrangement, the orientation of the magnetic field alternates in the direction of motion. This is used by the Transrapid and enables the simultaneous use of levitation and propulsion of the rail.\
In the homogeneous arrangement, the orientation of the magnetic field is the same in the direction of motion. This concept is used by TUM Hyperloop and requires a separate propulsion system to move the vehicle but allows a far simpler design of the levitation system.
