...
For yoke width, we again observed stronger field reduction at the nose and stronger field increase at the tail as width increased. In addition, relaxation of the nose dip toward the tail became slower for larger yoke widths. We attribute this to a larger loop diameter of the eddy currents, both in the transverse ($y$) direction and along the direction of motion ($x$). The braking-force fit showed a square dependence on yoke width.
...
Comparing the magnetic-field profile of the TUM Hyperloop design with the Yamamura model at the same velocity and yoke width, we observed stronger eddy currents, similar to those in the Yamamura model at larger yoke widths. This is caused by the wider rail width in the TUM Hyperloop design, which allows larger loop diameters of the eddy currents.
We found that a comparable profile in the Yamamura model, with similar shape and amplitudes, is obtained at approximately 2.5 times the yoke width of the TUM Hyperloop design.
...
The TUM Hyperloop design currently uses a flat rail profile. A U-shaped rail could support vehicle guidance, but it would also increase the magnetic flux path length and may strengthen eddy currents. On the other hand, in this design the effective rail surface facing the yoke has a significantly smaller width, which may reduce eddy currents.
