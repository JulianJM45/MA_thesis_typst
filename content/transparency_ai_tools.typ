...
I used GitHub Copilot (Claude Sonnet LLM model) to assist in drafting by completing sentences, caption figures, translating, and to support the review process.
Additionally, I used GitHub Copilot to generate code snippets to implement numerical calculations and postprocess data.
For spelling, grammar and style correction, I used ChatGPT and Harper-ls.

I have carefully reviewed all content generated by these tools to ensure its correctness and relevance to my thesis.
